...
import com.clevercloud.myakka.UserRegistry._
import akka.actor.typed.ActorRef
import akka.actor.typed.ActorSystem
import akka.actor.typed.scaladsl.AskPattern._
import akka.http.scaladsl.server.directives.Credentials
import akka.util.Timeout
import com.clevercloud.myakka.configuration.BasicAuthConfig

//#import-json-formats
//#user-routes-class
class UserRoutes(userRegistry: ActorRef[UserRegistry.Command], auth: BasicAuthConfig)(implicit val system: ActorSystem[_]) {
